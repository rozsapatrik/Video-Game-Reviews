...
if(isset($_POST['submitreview']))
  {
    ...
    $review = $connect->real_escape_string($_POST["reviewtext"]);
    
    $sql = "INSERT INTO reviews (GameID, UserID, Username, Review) VALUES (?, ?, ?, ?)";
    if($stmt = $connect->prepare($sql))
    {
      $stmt -> bind_param("iiss", $gid, $uid, $username, $review);
      $stmt -> execute();
      //header("location: seereviews.php");
    } else {
    $error = '<p class="text-danger text-center">SQL Error - Could not add review</p>';
    header("location: seereviews.php");
  }
  $stmt->close();
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="towriteareview.php">Write A Review  <span class="sr-only">(current)</span></a>
        ...
        <div id="content-wrap">
            <div class="blockdiv">
                ...
                <div class="label aboutus">
                    ...
                    <label class="reviewlabel">Review: (max 2000 characters)</label><br>
                    <textarea id="reviewtext" type="text" name="reviewtext" rows="15"></textarea><br>
                    <div id="divv"></div>
                    <button type="submit" name="submitreview" class="btn btn-outline-success my-2 my-sm-0">Submit Your Review</button></br>
                    </form>
                </div>
              </div>
            <div><img></div>
