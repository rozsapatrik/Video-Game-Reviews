...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="gotanissue.php">Got an issue? <span class="sr-only">(current)</span></a>
              </div>
            </li>
          </ul>
      ...
      <div id="page-container">
        <div id="content-wrap">
          <div class="blockdiv">
            <h1>If you have any issues contact us</h1>
            <div class="label aboutus">
              <p>If you have any issues contact us at:</p>
              <p>videogamereviews@gmail.com</p>
            </div>
          </div>
        </div>
