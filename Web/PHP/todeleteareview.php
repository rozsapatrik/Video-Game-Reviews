...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div id="page-container">
        <div id="content-wrap">
          <div class="blockdiv">
            <h1>How To Delete A Review (ONLY ADMIN)</h1>
            <div class="label aboutus">
              <p>How to delete a review to a game:</p>
              <p>1. Go to 'Game Reviews' tab -> See Reviews.</p>
              <p>2. Select a game you want to write a review for.</p>
              <p>3. Click on 'Delete a review for this game'</p>
              <p>4. Click on the 'X' next to the review you would like to delete.</p>
            </div>
          </div>
        </div>
